...
;;           | (VectType Type)
;;           | (FunType (listof Type) (ReturnType))
;;           | (RefType Type)
;;           | (RecType TypeName Type)
(struct DynType   ()    #:prefab)
(struct UnitType  ()    #:prefab)
(struct IntType  ()     #:prefab)
(struct BoolType  ()    #:prefab)
(struct CharType ()     #:prefab)
(struct StrType ()      #:prefab)
(struct TupleType (ts)  #:prefab)
(struct VecType (t)     #:prefab)
(struct FunType (ts rt) #:prefab)
